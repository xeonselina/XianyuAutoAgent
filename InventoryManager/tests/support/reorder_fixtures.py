...
class ReorderCase:
    ...
    def add_overlap_pair(self):
        ...
        predecessor = Rental(
            ...
            logistics_days=1,
            planned_ship_out_date=base - timedelta(days=1),
            planned_return_date=base + timedelta(days=7),
        ...
        successor = Rental(
            ...
            logistics_days=1,
            planned_ship_out_date=base + timedelta(days=4),
            planned_return_date=base + timedelta(days=11),
...
def seeded_reorder_case(db_session):
    ...
    child = Rental(
        ...
        logistics_days=second.logistics_days,
        planned_ship_out_date=second.planned_ship_out_date,
        planned_return_date=second.planned_return_date,
