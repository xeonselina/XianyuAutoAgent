...
SHARED_DATABASE_TESTS = (
    ...
    "tests/integration/test_default_backfill_mysql_composition.py",
    "tests/integration/test_default_migration_mariadb_lock_matrix.py",
    "tests/integration/test_legacy_unattributed_history_migration.py",
