...
def test_unsupported_target_stub_fails_closed_without_opening_a_database():
    ...
    with pytest.raises(DefaultSchemaQualificationTargetError):
        _schema._require_target(connection, target)
...
def test_mysql_target_identity_is_bound_to_exact_server_and_test_schema():
    ...
    _, another_server = _schema._require_target(
        _MySqlTargetConnection(server_uuid="89000000-0000-4000-8000-000000000098"),
        target,
    )
