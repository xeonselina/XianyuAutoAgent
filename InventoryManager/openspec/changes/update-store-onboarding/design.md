...
## Decisions
- The platform create-store request accepts an 8–128 character initial password. The backend hashes it before the first control-database write and never returns it.
